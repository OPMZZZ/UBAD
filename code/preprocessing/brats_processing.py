...
def preprocess(datapath: Path):
    ...
    splits_path = Path(__file__).parent.parent / "data" / "new_brats2021_preprocessed" / "data_splits"
    ...
    for split in ["train", "val", "test"]:
        ...
        for source_path in tqdm(paths):
            target_path = Path(__file__).parent.parent / "data" / "new_brats2021_preprocessed" / f"npy_{split}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--source", type=str, default="../../BraTS2021_Training_Data"
